...
// @ts-ignore
import handler from '../../../../../server/api/users/[userId]/getUserBasic.ts'
import fs from 'fs/promises'
import * as h3 from 'h3'

describe('User Get Basic API', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  ...
  it('should return basic info for a given user', async () => {
    const mockUsers = [
      { id: 'user1', username: 'Test', password: 'abc', avatar: 'avatar1.png' }
    ]
    ...
    expect(response).toEqual({
      status: 'success',
      userBasic: { id: 'user1', username: 'Test', avatar: 'avatar1.png' }
    })
